...
<html>
    ...
    <head>
        ...
        <!-- SCRIPTS -->
        <script type="text/javascript" src="//ajax.useso.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
        <script src="//cdn.bootcss.com/bootstrap/3.3.4/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?php echo THEMEPATH; ?>/js/directorylister.js"></script>

        <!-- FONTS -->
        <link rel="stylesheet" type="text/css"  href="//fonts.useso.com/css?family=Cutive+Mono">
