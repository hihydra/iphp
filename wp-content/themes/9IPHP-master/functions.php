...
function _9iphp_post_thumbnail( $width = 255,$height = 130 ){
   ...
   // $n = count($strResult[1]);
   // if($n > 0){
         return '<img class="thumb pull-left hidden-xs" src="'.get_bloginfo('template_directory').'/images/lazy_loading.gif" data-original="'.get_bloginfo("template_url").'/timthumb.php?w='.$width.'&amp;h='.$height.'&amp;src='.$first_img.'" title="'.get_the_title().'" alt="'.get_the_title().'"/>';
   // }
